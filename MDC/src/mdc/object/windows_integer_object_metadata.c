...
MDC_DEFINE_WINDOWS_INTEGER_OBJECT_METADATA(Mdc_INT8, INT8);
MDC_DEFINE_WINDOWS_INTEGER_OBJECT_METADATA(Mdc_INT16, INT16);
MDC_DEFINE_WINDOWS_INTEGER_OBJECT_METADATA(Mdc_INT32, INT32);
MDC_DEFINE_WINDOWS_INTEGER_OBJECT_METADATA(Mdc_INT64, INT64);

MDC_DEFINE_WINDOWS_INTEGER_OBJECT_METADATA(Mdc_UINT8, UINT8);
MDC_DEFINE_WINDOWS_INTEGER_OBJECT_METADATA(Mdc_UINT16, UINT16);
MDC_DEFINE_WINDOWS_INTEGER_OBJECT_METADATA(Mdc_UINT32, UINT32);
MDC_DEFINE_WINDOWS_INTEGER_OBJECT_METADATA(Mdc_UINT64, UINT64);
