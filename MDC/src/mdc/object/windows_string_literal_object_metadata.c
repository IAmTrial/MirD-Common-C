...
#define MDC_DEFINE_WINDOWS_STRING_LITERAL_OBJECT_METADATA(name, type) \
\
/**
...
MDC_DEFINE_WINDOWS_STRING_LITERAL_OBJECT_METADATA(Mdc_STRLiteral, CHAR);
MDC_DEFINE_WINDOWS_STRING_LITERAL_OBJECT_METADATA(Mdc_WSTRLiteral, WCHAR);
