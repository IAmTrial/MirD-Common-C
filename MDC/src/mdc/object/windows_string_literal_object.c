...
const CHAR** Mdc_STRLiteral_InitDefault(const CHAR** obj) {
  *obj = "";
  return obj;
}

const WCHAR** Mdc_WSTRLiteral_InitDefault(const WCHAR** obj) {
  *obj = L"";
  return obj;
}

const TCHAR** Mdc_TSTRLiteral_InitDefault(const TCHAR** obj) {
  *obj = TEXT("");
  return obj;
}

MDC_DEFINE_WINDOWS_STRING_LITERAL_OBJECT_FUNCS(Mdc_STRLiteral, CHAR);
MDC_DEFINE_WINDOWS_STRING_LITERAL_OBJECT_FUNCS(Mdc_WSTRLiteral, WCHAR);
