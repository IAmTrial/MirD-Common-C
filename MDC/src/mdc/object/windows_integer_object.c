...
MDC_DEFINE_WINDOWS_INTEGER_OBJECT_FUNCS(Mdc_INT8, INT8);
MDC_DEFINE_WINDOWS_INTEGER_OBJECT_FUNCS(Mdc_INT16, INT16);
MDC_DEFINE_WINDOWS_INTEGER_OBJECT_FUNCS(Mdc_INT32, INT32);
MDC_DEFINE_WINDOWS_INTEGER_OBJECT_FUNCS(Mdc_INT64, INT64);

MDC_DEFINE_WINDOWS_INTEGER_OBJECT_FUNCS(Mdc_UINT8, UINT8);
MDC_DEFINE_WINDOWS_INTEGER_OBJECT_FUNCS(Mdc_UINT16, UINT16);
MDC_DEFINE_WINDOWS_INTEGER_OBJECT_FUNCS(Mdc_UINT32, UINT32);
MDC_DEFINE_WINDOWS_INTEGER_OBJECT_FUNCS(Mdc_UINT64, UINT64);
