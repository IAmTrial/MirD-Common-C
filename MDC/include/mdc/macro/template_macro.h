...
#define MDC_T_DECLARE_TYPEDEFS(type_name) \
    ...
    /*MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T(type_name)) \
    MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T_P(type_name)) \
    MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T_C(type_name)) \
    MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T_PC(type_name)) \
    MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T_V(type_name)) \
    MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T_PV(type_name)) \
    MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T_CV(type_name)) \
    MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T_PCV(type_name))*/

#define MDC_T_DECLARE_DATA_TYPE_TYPEDEFS(data_type, tag_name) \
    MDC_INTERNAL_T_DECLARE_DATA_TYPE_TYPEDEFS(data_type, tag_name) \
    /*MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T(tag_name)) \
    MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T_P(tag_name)) \
    MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T_C(tag_name)) \
    MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T_PC(tag_name)) \
    MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T_V(tag_name)) \
    MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T_PV(tag_name)) \
    MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T_CV(tag_name)) \
    MDC_INTERNAL_T_DECLARE_TYPEDEFS(MDC_T_PCV(tag_name))*/
