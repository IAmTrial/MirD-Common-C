...
#define MDC_DECLARE_WINDOWS_STRING_LITERAL_OBJECT_FUNCS(name, type) \
\
/**
...
MDC_DECLARE_WINDOWS_STRING_LITERAL_OBJECT_FUNCS(Mdc_STRLiteral, CHAR);
MDC_DECLARE_WINDOWS_STRING_LITERAL_OBJECT_FUNCS(Mdc_WSTRLiteral, WCHAR);
MDC_DECLARE_WINDOWS_STRING_LITERAL_OBJECT_FUNCS(Mdc_TSTRLiteral, TCHAR);

#ifdef __cplusplus
} /* extern "C" */
#endif /* __cplusplus */

#undef MDC_DECLARE_WINDOWS_STRING_LITERAL_OBJECT_FUNCS
