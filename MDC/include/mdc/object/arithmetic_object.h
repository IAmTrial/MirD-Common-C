...
#ifndef MDC_C_OBJECT_ARITHMETIC_OBJECT_H_
#define MDC_C_OBJECT_ARITHMETIC_OBJECT_H_
...
#define MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(name, type) \
\
/**
...
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_Boolean, bool);

MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_SChar, signed char);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_Short, short);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_Integer, int);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_Long, long);

MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_Int8, int8_t);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_Int16, int16_t);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_Int32, int32_t);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_Int64, int64_t);

MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_IntLeast8, int_least8_t);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_IntLeast16, int_least16_t);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_IntLeast32, int_least32_t);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_IntLeast64, int_least64_t);

MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_IntMax, intmax_t);

MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_UChar, unsigned char);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_UShort, unsigned short);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_UInteger, unsigned int);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_ULong, unsigned long);

MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_UInt8, uint8_t);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_UInt16, uint16_t);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_UInt32, uint32_t);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_UInt64, uint64_t);

MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_UIntLeast8, uint_least8_t);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_UIntLeast16, uint_least16_t);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_UIntLeast32, uint_least32_t);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_UIntLeast64, uint_least64_t);

MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_UIntMax, uintmax_t);

MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_Intptr, intptr_t);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_UIntptr, uintptr_t);

#if __cplusplus >= 201103L \
    || __STDC_VERSION__ >= 201112L \
    || _MSC_VER >= 1600

MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_LLong, long long);
MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS(Mdc_ULLong, unsigned long long);
...
#undef MDC_DECLARE_ARITHMETIC_OBJECT_FUNCS

#include "../../../dllexport_undefine.inc"
#endif /* MDC_C_OBJECT_ARITHMETIC_OBJECT_H_ */
