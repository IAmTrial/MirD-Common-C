...
MDC_INTERNAL_DECLARE_DLLEXPORT_SIGNED_INTEGER(Mdc_LongLong)
MDC_INTERNAL_DECLARE_DLLEXPORT_UNSIGNED_INTEGER(Mdc_ULongLong)
...
MDC_INTERNAL_DECLARE_DLLEXPORT_UNSIGNED_INTEGER(Mdc_WInt)
