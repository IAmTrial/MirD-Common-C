...
#define MDC_INTERNAL_DECLARE_BASIC_STRING_VALUE_TYPE(CharT) \
    typedef CharT Mdc_BasicString_ValueType(CharT);

#define MDC_INTERNAL_DECLARE_BASIC_STRING_MEMBER_TYPES(CharT) \
    MDC_INTERNAL_DECLARE_BASIC_STRING_VALUE_TYPE(CharT)
