...
#ifndef MDC_C_STRING_INTERNAL_CHAR_TRAITS_H_
#define MDC_C_STRING_INTERNAL_CHAR_TRAITS_H_

#include "char_traits/char_traits_declare_macros.h"
#include "char_traits/char_traits_name_macros.h"

#define MDC_DECLARE_CHAR_TRAITS(CharT, int_type) \
